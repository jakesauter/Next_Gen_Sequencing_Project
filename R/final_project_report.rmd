...
```{r, echo=FALSE}
study_selected_genes_df <- structure(list('Adjusted P-value' = c("0.000041", "0.000041", "0.004718", "0.005319", 
...
"0.896340", "0.912330", "0.982388", "0.992804"), 'Log_2 Fold Change' = c(" 1.7407", 
...
```{r, echo=FALSE}
study_confirmed_genes_df <- structure(list('Adjusted P-value' = c("0.000041", "0.000041", "0.004718", "0.005319", 
"0.019995", "0.019995", "0.019995", "0.019995", "0.037131", "0.041758", 
"0.042672", "0.044855", "0.048952", "0.048952"), 'Log_2 Fold Change' = c(" 1.74", 
...
```{r, echo=FALSE}
my_de_genes_df <- structure(list('Adjusted P-value' = c("0.000041", "0.000041", "0.004718", "0.005319", 
...
"0.048952", "0.048952", "0.048952", "0.048952"), 'Log_2 Fold Change' = c(" 1.74", 
...
![](images/paste-B7115C2D.png){width="635"}
...
### **Converting Ensembl IDs to Gene symbols using GTF**
...
### **Normalizing read counts for Sequencing Depth and Gene Expression**
...
### **Exploratory Data Analysis with `DESeq2::rlog`**
...
### **APOE Genotype as a Possible Confounder**
...
We next must shrink the gene-wise dispersion estimates towards our expected dispersion values fitted by the red line in the previous step. This is required as values closer to the curve allow for more accurate identification of differentially expressed genes when samples sizes are small. This step is particularly helpful for **removing false positives** in our differential expression analysis. A key aspect of this fitting / normalization process is that most genes are shrunken towards the curve, though **extremely high dispersion values are not shrunken towards the curve**, due to the likelihood that the observed dispersion does not follow the modelling assumptions and has the observed higher variability due to other biological or technical reasons. The gene values that have not been shrunken towards the curve to avoid false-positives are **circled in blue**. 
